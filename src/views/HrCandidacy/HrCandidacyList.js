...
class HrCandidacy extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.props.getCandidateData({timePeriod:'',outcome:'',hiringManager:'',candidateName:'',skills:'',from:'',to:'',isActive:'',monthly:''});
        this.props.getHr(data)
        this.props.getHRAutocomplete()
    };
    componentDidUpdate = () => {
    ...
    render () {
        const columns = [
            ...
            { Header: "Submission Date", accessor: "createdOn",
            Cell : props =>
                    <span className='submissionTitle'>{moment(props.original.createdOn).format("DD MMM YYYY")}</span>,
                style: {
                    textAlign: "center"
                },
            },
            ...
            Cell : props =>
                    <span className='submissionTitle'>{props.original.interviewDate}</span>,
                    // {moment(props.original.interviewDate).format("DD MMM YYYY")}
                style: {
                    textAlign: "center"
                },
            },
        ...
        const hrdata4 = this.props.getHrcomplete ? this.props.getHrcomplete.map((e) => {
            return (
                {ename: e.candidateName,eid: e.id.toString()}
            )
        }): [];
        const skillsData = this.props.getHrcomplete && this.props.getHrcomplete.map((e,index)=>{
            return(
                <option key = {index} value={e.skills}>{e.skills}</option>
            )
        });
            ...
            <div className="mainPanel">
                <div className="page-content-inner">
                    <div className="page-header">
                        ...
                        {localStorage.getItem('userRole') === '3' || localStorage.getItem('roleId') === '2' || localStorage.getItem('userRole') === '5'?
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="user-view-box">
                                    ...
                                    <div className="user-details using-details">
                                        <div className="heading"><strong>Personal Details :</strong></div>
                                        <div className="user-details-list"><div className="name">Email</div><span>{this.state.viewData.email}</span></div>
                                        <div className="user-details-list"><div className="name">Phone</div><span>{this.state.viewData.phone}</span></div>
                                        <div className="user-details-list"><div className="name">Qualification</div><span>{this.state.viewData.qualification}</span></div>
                                        <div className="heading"><strong>Professional Details :</strong></div>
                                        <div className="user-details-list"><div className="name">InterView Date</div><span>{moment(this.state.viewData.interviewDate).format("DD MMMM YYYY")}</span></div>
                                        <div className="user-details-list"><div className="name">InterView Mode</div><span>{this.state.viewData.interviewMode}</span></div>
                                        <div className="user-details-list"><div className="name">InterView Time</div><span>{this.state.viewData.interviewTime}</span></div>
                                        <div className="user-details-list"><div className="name">Candidate Current Salary</div><span>{this.state.viewData.currentSalary}</span></div>
                                        <div className="user-details-list"><div className="name">Candidate Expected Salary</div><span>{this.state.viewData.expectedSalary}</span></div>
                                        <div className="user-details-list"><div className="name">Experience</div><span>{this.state.viewData.experience}</span></div>
                                        <div className="user-details-list"><div className="name">Notice Period</div><span>{this.state.viewData.noticePeriod}</span></div>
                                        <div className="user-details-list"><div className="name">Reason For Change</div><span>{this.state.viewData.reasonForChange}</span></div>
                                        <div className="user-details-list"><div className="name">Outcome</div><span>{this.state.viewData.outcome}</span></div>
                                        <div className="user-details-list"><div className="name">Hiring Manager</div><span>{this.state.viewData.hiringManager}</span></div>
                                        <div className="user-details-list"><div className="name">Skills</div><span>{this.state.viewData.skills}</span></div>
                                        <div className="user-details-list"><div className="name">Rounds</div><span>{this.state.viewData.rounds}</span></div>
                                    </div>
                                </div>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-gray btn-sm" data-dismiss="modal">Back</button>
                                    ...
                                    <Link to={{ pathname: `/hrCandidacy/edit/${this.state.viewData.id}`}} title="" data-original-title="Copy">
                    ...
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-theme btn-sm" name="isActive" data-dismiss="modal" onClick={() => this.props.isActive({id:this.state.id,isActive:0})}>ok</button>
                            </div>
                        </div>
                    </div>
                </div>   
...
const mapStateToProps = state => {
    ...
    const data1 = state.CtrlHrCandidacy.employeeFilters.data
    return {
      hrData: data,
      hrData2:state.CtrUser.userData.result,
      hrData3: state.CtrlHrCandidacy.getCandidate,
      getHrcomplete: data1,
    };
};
const mapDispatchToProps = dispatch => {
    return {
      ...
      getHRAutocomplete: () => dispatch(actionCreator.getHRSAutocompleteAction()),
    };
};
