...
class SelectedLeave extends React.Component {
    constructor() {
        super()
        this.state = {
            timePeriodStep: 1,
    ...
    componentDidMount = () => {
        this.props.GetleaveData({status: "approved",from:"",to:"",userid:"",timePeriod:'',outcome:'',monthly:''});
    }
    componentDidUpdate = () => {
    ...
    addEmployee = (data) => {
        this.props.GetleaveData({id: data, emp: "true"})
    }
    ...
    filterTimePeriod = (e) => {
        ...
        // () => {
        //     this.props.GetleaveData({status: "approved", ...timePeriod})
        // }
        )
    }
                    ...
                    <div className="theme-panel">
                        <div className="prosess-tab">
                            <ul className="nav nav-tabs">
                                ...
                                <li className="nav-item">
                                    <button className="nav-link active">Approved</button>
                                </li>
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectedLeave);
