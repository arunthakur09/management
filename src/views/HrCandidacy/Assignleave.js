            ...
            <div className="mainPanel">
                <div className="page-content-inner">
                    <div className="page-header">
                        <div className="main-title"><strong>Assign New Leave</strong></div>
                        ...
                        <div className="main-page-content">
                            ...
                            <div className="page-main">
                                ...
                                <div className="theme-footer">
                                    ...
                                    <button type="button" onClick={this.handleSubmit} className="btn btn-theme btn-sm float-right btn-save3">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
