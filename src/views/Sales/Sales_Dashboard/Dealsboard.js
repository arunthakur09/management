...
class Board extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.props.SalesData({status:"approved",add:true,clientName:""});
    };
                ...
                <div className="prosess-tab">
                    ...
                    <div id="searchfields" className="search-fields collapse show">
                        ...
                        <div className="row"><div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 b-right">
                                    <h3 style={{}}><b>Deals By Portal</b></h3>
                                    ...
                                    <h3 style={{}}><b>Deals By Domain</b></h3>
                                    ...
                                    <div className="graph-box">
                                        ...
                                        <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 ">
                                            <div className="lead-box">
                                                <span ><strong>Deals:<br /></strong><span style={{fontSize:"39px"}}>{this.props.salesData.proposalCount && this.props.salesData.proposalCount.length}</span></span>
                                            </div>
                                        </div>
