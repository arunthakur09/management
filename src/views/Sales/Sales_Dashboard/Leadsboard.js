...
class Board extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.props.SalesData({status:"discussion",add:true,clientName:"",from:'',to:'',monthly:''});
    };
    ...
    render() {
        ...
        const { tableRecords } = this.props.salesData;
        
        let finalDDD =  tableRecords ? [['Performance', 'Employee Performance'], ...tableRecords.statusCount.map(val => [val.status.replace('discussion', 'Leads').replace('approved', 'Deals'), val.count])] : [];
                ...
                <div className="prosess-tab">
                            <ul className="nav nav-tabs">
                                <li className="nav-item">
                                    <button className="nav-link active">Leads</button>
                                </li>
                                <li className="nav-item">
                    ...
                    <div id="searchfields" className="search-fields collapse show">
                        ...
                        <div className="graph">
                        <div className="row"><div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 b-right">
                                    <h3 style={{}}><b>Leads By Portal</b></h3>
                                    <Chart width={'auto'}
                                    ...
                                    <h3 style={{}}><b>Leads By Domain</b></h3>
                                    <Chart width={'auto'}
                                        height={'400px'} chartType="PieChart"
                                        loader={<div>Loading Chart</div>}
                                        data={[
                                    ...
                                    /></div>
                                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 b-right">
                                    <h3 style={{}}><b>Total Proposals</b></h3>
                                    <Chart width={'auto'}
                                        height={'400px'} chartType="PieChart"
                                        loader={<div>Loading Chart</div>}
                                        data={finalDDD}
                                    ...
                                    <div className="graph-box">
                                        ...
                                        <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 ">
                                            <div className="lead-box">
                                                <span ><strong>Total Proposals: <br /></strong>
                                                <span style={{fontSize:"39px"}}>{TotalProposals}
                                        ...
                                        <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 ">
                                            <div className="lead-box">
                                                <span ><strong>Leads:<br /></strong><span style={{fontSize:"39px"}}>{this.props.salesData.proposalCount && this.props.salesData.proposalCount.length}</span></span>
                                            </div>
                                        </div>
