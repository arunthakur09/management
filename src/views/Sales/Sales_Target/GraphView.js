...
class GraphView extends React.Component {
    ...
    render () {
        ...
        var months = [
            ...
            var data1 = [['Yearly Graph',  'Achieve Target', 'Pending Target']]
            this.props.salesData.data && this.props.salesData.data.map(target => (
            data1.push([months[parseInt(target.month)-1], target.Revenue, target.pending])
        ));
        console.log(data1)
        return (
            <div>
                <div className="theme-panel">
                    <div className="performance-box">
                        ...
                        <div className="performance-details" key={target.userId}>
                            ...
                            {index<1 ? 
                        <Chart style={{marginLeft: "20%"}} width={'200px'}
                        height={'300px'} 
                ...
                <div className="theme-panel">
                    ...
                    <div className="performance-details">
                        {this.props.salesData.data && this.props.salesData.data[0].month ? null:
