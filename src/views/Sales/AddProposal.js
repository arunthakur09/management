...
class AddProposal extends React.Component {
    ...
    componentDidMount = () => {
        this.props.getDropDownData({isActive:'',dept:'',jobTitle:'',supervisor:'',userid:'',employeeStatus:'',from:'',to:'',timePeriod:'',firstName:'',monthly:''});
    }
    ...
    handleKra1 = (e) => {console.log('>>>>>>>>>',e)
        this.setState({
            pitchContent: e.blocks[0].text
        });
        console.log(e.blocks[0].text)
    };
    handleKra2 = (e) => {console.log('>>>>>>>>>',e)
        this.setState({
            jobRequirement: e.blocks[0].text
        });
        console.log(e.blocks[0].text)
    };
    ...
    render () {
        ...
        const systemcount = this.props.salesDropDown.systemcount && this.props.salesDropDown.systemcount.map(users => {
            return (
                <option value={users.id} key={users.id}>{users.firstName}</option>
            )
        })
        return (
                ...
                <div className="page-content-inner">
                    <div className="page-header">
                        ...
                        <ul className="page-top-actions">
                            <li><label className="custom-file-upload"><input type="file" onChange={this.csvUpload}/><i class="fa fa-upload" aria-hidden="true" title="Download CSV Sample"></i><span>Import</span></label></li>
                            {this.state.portal!=="LinkedIn" ?
                    <li><CsvDownloader columns={columnss} filename="Sample" separator=";" wrapColumnChar=""><button className="btn green importBtn">
                        <i class="fa fa-download" aria-hidden="true" title="Download CSV Sample"></i><span>Download</span></button></CsvDownloader></li>
                        :
                    <li><CsvDownloader columns={columns} filename="Sample" separator=";" wrapColumnChar=""><button className="btn green importBtn">
                        <i class="fa fa-download" aria-hidden="true" title="Download CSV Sample"></i><span>Download</span></button></CsvDownloader></li>}
                            ...
                            <div className="page-main">
                                <div className="theme-content">
                                    <div className="form-vertical">
                                        ...
                                        <div className={this.state.portal!=='LinkedIn' ? "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 b-right":"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 b-right"} ><br />
                                            ...
                                            <div >
                                                <div className="form-group">
                                                    <label className="control-label">Sales User's <span style={{color:"red",fontSize:"13px"}}>*</span></label>
                                                    <div className="controls">
                                                        <select className="form-control" name="userId" onChange={this.handleChange}>
                                                            <option value="">Select Please</option>{systemcount}
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div >
                                                <div className="form-group">
                                                    ...
                                                    <div className="controls">
                                                        ...
                                                        value={this.state.profile} onChange={this.handleChange} required/>
                                                    </div>
                                                </div>
                                            </div>	
                                                {/* <div className="form-group">
                                        ...
                                        {this.state.portal!=='LinkedIn' ? 
                                        <div className="col-xl-6 col-lg-3 col-md-3 col-sm-12 col-12 b-right" ><br />
                                            ...
                                            <div className="col-xl-6">    
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="controls">
                                                        <input type="Time" className="form-control" name="proposalTime" placeholder="Proposal Time"
                                                        value={this.state.proposalTime} onChange={this.handleChange} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="controls">
                                                        ...
                                                        // toolbarHidden={this.state.hideToolbar}
                                                          ...
                                                          editorClassName="editorClassName" name="jobRequirement" placeholder="Please Job Requirement write here..."
                                                          value={this.state.jobRequirement} onChange={(e) => this.handleKra2(e)}
                                                        />
                                            ...
                                            <div className="col-xl-12">
                                            <div className="pitch-content-margin">
                                                <div className="form-group">
                                                    ...
                                                    <div className="controls">
                                                        ...
                                                        // toolbarHidden={this.state.hideToolbar}
                                                          ...
                                                          editorClassName="editorClassName" name="c" placeholder="Please write here..."
                                                          value={this.state.pitchContent} onChange={(e) => this.handleKra1(e)}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
...
const mapStateToProps = (state) => {
    console.log(state,">>>>>>>>")
    const dropDown = state.CtrUser.userData
    return {
